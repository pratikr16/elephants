...
ggplot()+
  geom_segment(aes(x = 10, xend = 40, y = 0, yend =0), lty = 2, col = 1)+
  
  geom_rect(aes(xmin = c(10), xmax = c(40), ymin = c(13.38, -2.198, 5.672), ymax = c(13.77, -1.805, 5.902)), 
 ...
 # geom_hline(yintercept = c(13.577, -2.00, 5.787), lty = 2, col = 1, size = 0.2)+
  ...
  geom_smooth(data = ele.ba.test, aes(x = mean, y = pred-ci), col = 2, lty = 3, size = 0.5,se=F)+
...
pdf(file = "figs/fig02temp_measures.pdf",height = full, width = full)
#png(filename = "fig_thermochron_data.png",height = 1600, width = 3200, res = 400)

grid.arrange(fig_temp_measure_hour, fig_temp_measure_relation, fig_temp_bland_altman, fig_landsat_ba_test, nrow = 2)
