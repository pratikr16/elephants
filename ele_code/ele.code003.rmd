...
fig_thermochron_plot_a =  
  ggplot()+
    geom_pointrange(data = ele.tow02, aes(x = hour, y = meantemp, ymin = meantemp-t.ci, ymax = meantemp+t.ci, col = season2,shape = season2), position = position_dodge(width = 0.2), fill = "white", fatten = 10, stroke = 0.7, lty = 1, lwd = 0.2)+

  geom_pointrange(data = towtemp, aes(x = hour, y = meantempa, ymin = meantempa-ta.ci, ymax = meantempa+ta.ci, fill = season2, shape = season2), position = position_dodge(width = 0.2), col = "grey20", fatten = 10, stroke = 0.7, lty = 1, lwd = 0.2)+
