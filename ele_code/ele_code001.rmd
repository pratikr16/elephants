...
cairo_pdf(filename = "ele_figA1.pdf", height = 4, width = 8)

ele %>% mutate(season = ifelse(season2 == "wet", "hot","cool")) %>% group_by(year_season = paste(year(time), season, sep = "_")) %>% count(id) %>%
  ggplot()+
