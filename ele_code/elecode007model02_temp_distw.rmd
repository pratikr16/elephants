...
ele.temp.distw %>% 
  ...
  geom_pointrange(aes(x = distw_round, y = t.mean, ymin = t.mean-t.ci, ymax = t.mean+t.ci, col = season2, shape = season2), fatten = 3, fill = "white",position = position_dodge(width = 0.5),lwd = 0.5, lty = 2)+
