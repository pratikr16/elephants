...
ele4 = ele3 %>% filter(wvint > 3, wvint < 25)
...
loopdata = loopdata %>% dplyr::select(loopprop, mindw, waterdiff, temp, fpt, loop, season2, v, tempchange, woody.density, hour, ambtempdiff)


ggplot(loopdata)+
  geom_smooth(aes(x = loopprop, y = temp, col = season2, fill = season2))+
