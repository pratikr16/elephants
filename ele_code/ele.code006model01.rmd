...
ele.fig.distw.time %>%
  ...
  geom_pointrange(aes(x = hour, y = distw.mean/1e3, ymin = (distw.mean-distw.ci)/1e3, ymax = (distw.mean+distw.ci)/1e3, col = season2, shape = season2), fatten = 10, fill = "white", lty = 1, lwd = 0.2, position = position_dodge(width = 0.5), stroke = 0.7)+
