...
```{r}
#'50m sampling grid from ele extent file
#'make topology
grid.topo = GridTopology(cellcentre.offset = bbox(as(ext, "Spatial"))[,1]+c(100,100)/2, cellsize = c(100,100), cells.dim = ceiling(diff(t(bbox(as(ext, "Spatial"))))/c(100,100)))
